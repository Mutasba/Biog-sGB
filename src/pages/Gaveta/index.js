    ...
    return (
        <View style={styles.drawerContent}>
            ...
            <TouchableOpacity style={styles.menuItem} onPress={() => navigation.navigate('Users')}>
                ...
                <Text style={styles.menuText}>Ususarios</Text>
            </TouchableOpacity>
...
export default function Gaveta({ route }) {
    ...
    return (
        <NavigationContainer independent={true}>
            ...
            >
                ...
                <Drawer.Screen
                    name="Users"
                    component={Users} // Certifique-se de criar esse componente

                />
                <Drawer.Screen
                    name="CriarConta"
                    component={CriarConta} // Certifique-se de criar esse componente
